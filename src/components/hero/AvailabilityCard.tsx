...
>(({ className, ...props }, ref) => {
  return (
    <Card
      ...
      padding="sm"
      className={cn(
        "bg-white/85 dark:bg-slate-100/85 backdrop-blur-md border border-white/80 dark:border-white/10 shadow-[0_12px_32px_-8px_rgba(18,18,18,0.06)] p-4 flex flex-col gap-2 rounded-[var(--radius-2xl)]",
        className,
      )}
      {...props}
    >
      ...
      <div className="flex items-center justify-between gap-3 pt-1">
        <p className="text-medium font-bold text-[var(--color-text-primary)] leading-tight">
