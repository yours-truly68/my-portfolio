      ...
      case "forge":
        return (
          <div
            ref={ref}
            className={cn(
              "relative w-full h-[230px] sm:h-[240px] rounded-2xl overflow-hidden bg-gradient-to-b from-[#0e0f1d] via-[#121327] to-[#07070d] flex items-center justify-center border border-white/10 select-none",
              className
            )}
            {...props}
          >
            {/* Deep Cosmic Space Grid & Glowing Celestial Energy Core */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(123,97,255,0.35)_0%,transparent_75%)]" />
            <div className="absolute w-[280px] h-[280px] rounded-full border border-purple-500/20 animate-spin-slow" />
            <div className="absolute w-[200px] h-[200px] rounded-full border border-indigo-400/25" />
            <div className="relative w-14 h-14 rounded-full bg-gradient-to-tr from-purple-600 to-indigo-400 shadow-[0_0_40px_rgba(123,97,255,0.9)] flex items-center justify-center">
      ...
      case "kando":
        return (
          <div
            ref={ref}
            className={cn(
              "relative w-full h-[230px] sm:h-[240px] rounded-2xl overflow-hidden bg-[#e5e4e2] p-3.5 flex flex-col gap-2 border border-black/5 select-none",
              className
            )}
            {...props}
          >
            {/* Kanban Workspace Minimal UI Mockup */}
            <div className="grid grid-cols-3 gap-2.5 h-full text-[0.65rem]">
              {/* To Do Column */}
              <div className="bg-[#eeedeb] rounded-xl p-2.5 flex flex-col gap-2 border border-black/5">
      ...
      case "gale":
        return (
          <div
            ref={ref}
            className={cn(
              "relative w-full h-[230px] sm:h-[240px] rounded-2xl overflow-hidden bg-gradient-to-br from-[#161826] via-[#1a1d30] to-[#0f111c] p-4 flex flex-col items-center justify-center border border-white/10 select-none",
              className
            )}
            {...props}
          >
            {/* Medical RAG Chat Card Mockup */}
            <div className="w-[92%] bg-white/95 rounded-2xl p-4 shadow-xl text-slate-800 flex flex-col gap-2.5 relative">
              <span className="text-xs text-slate-500 font-medium">
                What are the early signs of Type 2 diabetes?
              </span>
              <p className="text-xs text-slate-700 leading-relaxed font-medium bg-purple-50 p-2.5 rounded-xl border border-purple-100">
                Early signs of Type 2 diabetes can include increased thirst, frequent urination, fatigue, and blurred vision...
              </p>
              <div className="absolute right-3 bottom-3 w-7 h-7 rounded-full bg-purple-600 text-white flex items-center justify-center shadow-md">
      ...
      default:
        return (
          <div
            ref={ref}
            className={cn(
              "relative w-full h-[230px] sm:h-[240px] rounded-2xl overflow-hidden bg-[#0a0b14] p-4 flex flex-col gap-3 border border-white/10 select-none",
              className
            )}
            {...props}
          >
            {/* Dark AI Search Engine Interface & Progress Result Bars */}
            ...
            <div className="flex flex-col gap-2 pt-2">
              ...
              <div className="h-2 w-2/3 bg-indigo-500/40 rounded-full" />
            </div>
          </div>
        );
    }
